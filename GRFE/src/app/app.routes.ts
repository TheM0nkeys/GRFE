...
import { GerenciadorAdminComponent } from './components/layout/admin/gerenciador-admin/gerenciador-admin.component';
...
export const routes: Routes = [
  ...
  {path: 'navbar', component: NavbarComponent/*, canActivate: [roleGuard]*/, children: [
      ...
      {path: 'admin', component: GerenciadorAdminComponent},
